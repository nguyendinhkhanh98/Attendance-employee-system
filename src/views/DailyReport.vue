      ...
      <table class="table table-bordered table__employee-detail">
        <thead>
          <tr>
            ...
            <th scope="col" class="table-item">Date <i class="fas fa-sort"></i></th>
            <th scope="col" class="table-item">Activity <i class="fas fa-sort"></i></th>
            <th scope="col" class="table-item">Outcome <i class="fas fa-sort"></i></th>
